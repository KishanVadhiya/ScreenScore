...
const Movie = () => {
    ...
    const getData = () => {
        fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=411cfcd00abfb4ad2758f036924d9ba6&language=en-US`)
        .then(res => res.json())
    ...
    return (
        <div className="movie">
            ...
            <div className="movie_links">
                ...
                {
                    currentMovieDetail && currentMovieDetail.homepage && <a href={currentMovieDetail.homepage} target="_blank" style={{textDecoration: "none"}}><p><span className="movie_homeButton movie_Button">Homepage</span></p></a>
                }
                {
                    currentMovieDetail && currentMovieDetail.imdb_id && <a href={"https://www.imdb.com/title/" + currentMovieDetail.imdb_id} target="_blank" style={{textDecoration: "none"}}><p><span className="movie_imdbButton movie_Button">IMDb</span></p></a>
                }
            </div>
